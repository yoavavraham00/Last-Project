...
app.use(cors({
  origin: 'http://localhost:3001', // This is the client's address during development
  methods: 'GET,HEAD,PUT,PATCH,POST,DELETE', // These are the methods allowed from the client
