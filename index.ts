...
const PORT = process.env.EXPRESS_PORT; // get the Express port from the .env file

app.use(cors({origin:"http://localhost:5173"})); // const app to start using the cors middleware
